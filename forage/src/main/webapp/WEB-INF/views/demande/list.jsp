...
<html lang="fr">
    <head>
        ...
        <title>Liste des Demandes - GestionForage</title>
        <style>
    ...
    <body>
        ...
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="${pageContext.request.contextPath}/status-demandes">Statut Demande</a></li>
            </ul>
        </nav>
        ...
        <div class="container">
            ...
            <div class="actions-bar">
                <span>${demandes.size()} demande(s)</span>
                <a href="${pageContext.request.contextPath}/demandes/new" class="btn btn-green">+ Nouvelle Demande</a>
            </div>
                        ...
                        <tbody>
                            <c:forEach items="${demandes}" var="demande">
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${demande.status.libele == 'DEMANDE_TERMINEE'
                                            and not empty demande.statusHistorique}">
                                            ${demande.statusHistorique[0].dureeTravail} min
                                        </c:when>
                                        <c:otherwise>
            ...
            <c:otherwise>
                <div class="empty-state">
                    ...
                    <a href="${pageContext.request.contextPath}/demandes/new" class="btn btn-green">Creer une demande</a>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
